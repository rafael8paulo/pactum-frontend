# Spec: gerar-lancamentos-recorrentes-ui

## Purpose

Fluxo de geração manual dos lançamentos de despesa do mês a partir das contas recorrentes cadastradas, disparado por um botão em `/contas-recorrentes`, com feedback via toast e invalidação do cache de despesas.
