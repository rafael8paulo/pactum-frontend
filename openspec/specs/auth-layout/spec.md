...
Layout compartilhado entre as telas de autenticação (`/login` e `/cadastro`), sem Sidebar nem Header do dashboard, com card centralizado e identidade visual do app.
