...
Comportamento genérico e reutilizável de ordenação client-side por coluna nas tabelas de listagem (Despesas, Receitas), permitindo ao usuário reordenar os dados já carregados clicando nos cabeçalhos, sem depender de suporte de ordenação na API.
