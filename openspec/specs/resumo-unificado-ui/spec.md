# Spec: resumo-unificado-ui

## Purpose

Tela `/resumo-unificado` que combina, numa única página, os totais mensais e as listas de despesas e receitas — uma visão consolidada adicional que coexiste com `/resumo`, `/despesas` e `/receitas`, sem substituí-las.
