...
Defines the per-item loading state pattern for inline action buttons (delete, status toggle) in tables and cards, preventing accidental double-actions and giving users targeted feedback.
