# Spec: cadastro-screen

## Purpose

Tela pública de cadastro de novo usuário, com formulário validado, tratamento de erros inline e redirecionamento automático para usuários já autenticados.
