...
Deploy contínuo do frontend via GitHub Actions: a cada push em `main`, valida o código com lint, constrói e publica a imagem Docker no GHCR, e atualiza o serviço em execução na VPS via SSH.
