# Spec: global-feedback

## Purpose

Padrões de feedback visual globais da aplicação: notificações toast para resultados de ações, skeletons de loading durante carregamento de dados e estado vazio padronizado para listas sem itens.
